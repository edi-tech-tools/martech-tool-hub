  ...
  return (
    <div className="relative min-h-screen bg-[#120a0c] pt-28 pb-20 px-6">
      ...
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="space-y-8 text-sm text-[#a08088] leading-relaxed">
          <section>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">2. Information We Collect</h2>
            <h3 className="text-lg font-semibold text-[#f5e8ea] mb-2">Personal Data</h3>
            <p className="mb-3">
            ...
            <h3 className="text-lg font-semibold text-[#f5e8ea] mb-2">Automatically Collected Data</h3>
            <p className="mb-3">
            ...
            <h3 className="text-lg font-semibold text-[#f5e8ea] mb-2">Cookies and Tracking Technologies</h3>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">3. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">4. Information Sharing and Disclosure</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">5. Cookie Policy</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">6. Your Rights (GDPR & CCPA)</h2>
            <p className="mb-3">
            ...
            <p className="mt-3">
              To exercise any of these rights, please contact us at privacy@martech-tools.net. We
              will respond to your request within 30 days.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">7. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">8. Third-Party Links</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">9. Children's Privacy</h2>
            <p>
              ...
              us at privacy@martech-tools.net.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">10. International Data Transfers</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">11. Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-[#f5e8ea] mb-3">12. Contact Us</h2>
            <p>
              If you have questions about this Privacy Policy or our data practices, please
              contact us:
            </p>
            <div className="mt-4 p-5 bg-[#0F1D32] border border-[rgba(180,60,80,0.15)] rounded-xl">
              <p className="mb-2"><strong className="text-[#f5e8ea]">Email:</strong> privacy@martech-tools.net</p>
